...
public abstract class BaseLantuWxPayServiceImpl<H, P> implements LantuWxPayService, RequestHttp<H, P> {
    ...
    protected <T, E> T executeInternal(RequestExecutor<T, E> executor, String uri, E data, boolean doNotAutoRefresh)
